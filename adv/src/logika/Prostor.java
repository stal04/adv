...
public class Prostor {
	 ...
	 *
	 * @param nazev
	 *            nazev prostoru, jednoznačný identifikátor, jedno slovo nebo
	...
	/**
	 * Definuje východ z prostoru (sousední/vedlejsi prostor). Vzhledem k tomu, že
	 * je použit Set pro uložení východů, může být sousední prostor uveden pouze
	 * jednou (tj. nelze mít dvoje dveře do stejné sousední místnosti). Druhé zadání
	 * stejného prostoru tiše přepíše předchozí zadání (neobjeví se žádné chybové
	 * hlášení). Lze zadat též cestu ze do sebe sama.
	 *
	 * @param vedlejsi
	 *            prostor, který sousedi s aktualnim prostorem.
	 *
	 */
	...
	/**
	 * Metoda equals pro porovnání dvou prostorů. Překrývá se metoda equals ze třídy
	 * Object. Dva prostory jsou shodné, pokud mají stejný název. Tato metoda je
	 * důležitá z hlediska správného fungování seznamu východů (Set).
	 *
	 * Bližší popis metody equals je u třídy Object.
	 *
	 * @param o
	 *            object, který se má porovnávat s aktuálním
	...
	/**
	 * metoda hashCode vraci ciselny identifikator instance, ktery se pouziva pro
	 * optimalizaci ukladani v dynamickych datovych strukturach. Pri prekryti metody
	 * equals je potreba prekryt i metodu hashCode. Podrobny popis pravidel pro
	 * vytvareni metody hashCode je u metody hashCode ve tride Object
	 */
	@Override
	public int hashCode() {
		int vysledek = 3;
	 ...
	 * mistnosti/prostoru vstupni hala budovy VSE na Jiznim meste. vychody: chodba
	 * bufet ucebna
	 *
	...
	/**
	 * Vrací textový řetězec, který popisuje sousední východy, například: "vychody:
	 * hala ".
	 *
	 ...
	 * vrací se hodnota null, priestor sa vyhledává v listu prostoru.
	 *
	 * @param nazevSouseda
	 *            Jméno sousedního prostoru (východu)
	 * @return Prostor, který se nachází za příslušným východem, nebo hodnota null,
	 *         pokud prostor zadaného jména není sousedem.
	 */
	...
	/**
	 * Vrací kolekci obsahující prostory, se kterými tento prostor sousedí. Takto
	 * získaný seznam sousedních prostor nelze upravovat (přidávat, odebírat
	 * východy) protože z hlediska správného návrhu je to plně záležitostí třídy
	 * Prostor.
	 *
