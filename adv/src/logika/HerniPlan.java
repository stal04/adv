...
public class HerniPlan extends Observable{
    ...
    private void zalozProstoryHry() {
        ...
        Prostor hospoda = new Prostor("hospoda","hospoda, v ktorej varí krčmár pivo", 18.0, 90.0);
        ...
        Prostor kralovstvi = new Prostor("kralovstvi","kráľovstvo, ktorému zmizol drak, kráľovstvo ti dalo za úlohu priniesť mu draka", 18.0, 150.0);
