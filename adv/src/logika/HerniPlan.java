...
public class HerniPlan extends Observable {
	 ...
	 * aktuální prostor nastaví kralovstvi.
	 */
	private void zalozProstoryHry() {
		...
		Prostor radnice = new Prostor("radnice",
				"radnica v ktorej sa nachádzajú rôzne spisy, dokumenty a informácia, že drak sa nachádza v nepriateľskom kráľovstve!",
				130.0, -134.0);
		Prostor nepratelskeKralovstvi = new Prostor("nepratelske_kralovstvi",
				"nepriateľské kráľovstvo, ktoré strážia strážci", 140.0, 0.0);
		Prostor carodej = new Prostor("carodej", "doupě chamtivého čarodeja, ktorý prahne po diamantoch", 74.0, -192.0);
		Prostor kralovstvi = new Prostor("kralovstvi",
				"kráľovstvo, ktorému zmizol drak, kráľovstvo ti dalo za úlohu priniesť mu draka", 0.0, 0.0);
		...
		hospoda.vlozPostavu(
				new Postava("krcmar", "Informácie vymením len za recept na staré pivo, nájdeš ho v knihovne."));
		carodej.vlozPostavu(new Postava("carodej", "Vymením lektvar za diamant."));
		vedec.vlozPostavu(new Postava("vedec",
				"Informácie dám, len ak uhádneš rovnicu x^2-6x+9=0, zadaj výsledok v tvare res_rovnici cislo."));
